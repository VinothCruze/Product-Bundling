...
with open(r'Auto_merge.pkl', 'rb') as auto:
...
with open(r'Construction_merge.pkl', 'rb') as construction:
    # Load the pickled object
...
with open(r'Cargo_merge.pkl', 'rb') as cargo:
    # Load the pickled object
...
with open(r'Metal_merge.pkl', 'rb') as metal:
    # Load the pickled object
...
with open(r'ConstrSite project_merge.pkl', 'rb') as cp:
    # Load the pickled object
...
with open(r'House Engineering_merge.pkl', 'rb') as he:
    # Load the pickled object
...
with open(r'Engineering workshop (Betriebswerkstatt)_merge.pkl', 'rb') as ew:
    # Load the pickled object
...
with open(r'Wood_merge.pkl', 'rb') as wood:
    # Load the pickled object
...
@app.route('/page2')
def page2():
    with open(r'hyperparam.pkl', 'rb') as hp:
        # Load the pickled object
...
@app.route('/page3')
def page3():
    return render_template('NCF_Results.html')
...
@app.route('/page5')
def page5():
    return render_template('ncf_cluster.html')
